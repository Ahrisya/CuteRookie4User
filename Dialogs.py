...
class MoreDialog(QDialog):
	...
	def initUI(self):
		...
		self.mainLayout.addWidget(QLabel('QQ'), 1, 0, Qt.AlignCenter)
		self.mainLayout.addWidget(QLabel('1282519861'), 1, 1, Qt.AlignCenter)
		...
		self.mainLayout.addWidget(QLabel(self.version + '（' + self.last_update_time + '）'), 5, 1, Qt.AlignCenter)

		self.mainLayout.addWidget(QLabel('模型每周一下午更新，请及时前往项目主页或GitHub下载。'), 6, 0, 1, 2, Qt.AlignCenter)
